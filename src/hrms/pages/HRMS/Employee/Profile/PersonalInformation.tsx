      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6 sticky top-6 h-fit">
          <div className="bg-white border rounded-xl shadow-sm p-6 text-center">
            ...
            <span
              className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-semibold ${user.status === "ACTIVE"
                ...
                userDocs.map((doc) => (
                  <div key={doc._id} className="p-3 border rounded-lg bg-gray-50/50">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[10px] font-bold text-gray-600 truncate mr-2" title={DOC_LABEL_MAP[doc.documentType] || doc.documentType}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                ...
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold ${
                  user.employmentStatus === 'CONFIRMED' ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'
                }`}>
                  {user.employmentStatus}
                </span>
              </div>
